# R in Google Colab
Run R programs in Google Colab: You can use R programming language in Google Colab by 
Go to this URL: https://colab.research.google.com/#create=true&language=r, or this short URL https://colab.to/r. 
It will open a new notebook with R set as the kernel instead of Python.
